...
* on a given path.
* 
* <p>It fetches a path from the SnakePath input source and
...
public class FollowLeaderPath extends IWillFollowAction {
    ...
    public ActionResult behave(TextObject to) {
        ...
        if (isLeader(to).get()) {
            ...
            ArrayList path = isrcMousePath.getPath(getPathId(to));
